...
using MobilePhoneLoader.Class.Objects;
...
namespace MobilePhoneLoader.Class.Managers
{
    public class CommunicationManager
    {
        ...
        private string userName = "tl_mobilephone_c";
        ...
        public bool SendTrade(string subject, string content)
        {
            try
            {
                ...
                mailMessage.From = new MailAddress("tl_mobilephone_c@163.com");
                mailMessage.To.Clear();
                mailMessage.To.Add("tl_mobilephone@163.com");
